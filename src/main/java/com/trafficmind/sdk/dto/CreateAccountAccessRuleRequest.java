...
public class CreateAccountAccessRuleRequest {
    ...
    public CreateAccountAccessRuleRequest() {}
    ...
    public String toString() {
        return "CreateAccountAccessRuleRequest{" + "configuration=" + configuration + ", " + "mode=" + mode + ", " + "notes=" + notes + "}";
    }
}
